      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4 lg:grid-cols-7">
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-xs leading-relaxed">
              ...
              Arabic and English, raises the ticket, chases it to closure, and
              hands your team leads that are already qualified.
            </p>
            <div className="mt-5 flex items-start gap-2 border border-border p-3 max-w-xs bg-ink-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Compliant with Oman&rsquo;s Personal Data Protection Law (Royal
                Decree 6/2022, in force 2023). Zero customer data ever leaves
                Oman.
              </p>
            </div>
            ...
            >
              Need voice calls too? Visit {site.sister.domain}
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-border pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} {site.name}. Muscat, Sultanate of Oman.
          </p>
